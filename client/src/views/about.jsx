...
export default function About(){
    ...
    return(
        <>
        <div className="bg-gradient-to-r from-gray-900 items-center via-neutral-900 to-gray-900 h-screen">
            <div className="sm:flex-row flex flex-col sm:justify-around items-end sm:items-center p-4 sm:p-0 h-auto sm:h-screen">
                <div className="flex flex-col items-end sm:w-2/4 text-white gap-5">
                    <div className="flex flex-col gap-5">
                        <h1 className="sm:text-4xl text-xl">A propos</h1>
                        ...
                        <div className="text-white font-semibold sm:flex hidden gap-2">
